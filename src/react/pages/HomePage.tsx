        ...
        <div className="home-container">
          <IonCard className="hero-navy-card">
            <IonCardContent className="hero-navy-content">
              <div className="profile-top-row">
                ...
                <button type="button" className="btn-ganti-petugas">
          ...
          <IonCard className="hero-blue-cta">
            <IonCardContent className="hero-blue-content">
              ...
              <IonButton expand="block" className="btn-start-trip" onClick={() => navigate('/create-trip')}>
          ...
          <div className="section-title-row">
            ...
            <a className="link-see-all" onClick={() => navigate('/tabs/history')}>
